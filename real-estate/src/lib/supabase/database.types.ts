  ...
  public: {
    Tables: {
      buyer_preferences: {
        ...
        Relationships: [
          {
            foreignKeyName: "buyer_preferences_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
      ...
      listing_images: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "listing_images_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      scraped_listings: {
        ...
        Relationships: [
          {
            foreignKeyName: "scraped_listings_duplicate_of_fkey"
          ...
          {
            foreignKeyName: "scraped_listings_imported_listing_id_fkey"
          ...
          {
            foreignKeyName: "scraped_listings_reviewed_by_fkey"
            columns: ["reviewed_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "scraped_listings_source_id_fkey"
            columns: ["source_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "scraped_listings_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      scraper_runs: {
        ...
        Relationships: [
          {
            foreignKeyName: "scraper_runs_source_id_fkey"
            columns: ["source_id"]
            isOneToOne: false
            referencedRelation: "scraper_sources"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "scraper_runs_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      scraper_sources: {
        ...
        Relationships: [
          {
            foreignKeyName: "scraper_sources_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
