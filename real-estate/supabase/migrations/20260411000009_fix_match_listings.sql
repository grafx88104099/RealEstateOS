-- match_listings функцийг listings хүснэгтийн бодит column-уудтай нийцүүлэх
-- latitude, longitude, images column байхгүй тул хасав
-- Return type өөрчилсөн тул DROP + CREATE хэрэгтэй
